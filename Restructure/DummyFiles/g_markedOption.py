...
if __name__ == "__main__":
    ...
    mapped_json_path = os.path.join(base_folder, "annotate_" + batch_name, "field_mappings.json")
    image_folder = os.path.join(base_folder, "TestData", batch_name, "processed_" + batch_name)

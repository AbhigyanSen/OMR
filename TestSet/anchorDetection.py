...
if __name__ == "__main__":
    ...
    annotations_file = os.path.join(base_folder, "Annotations", "anchor_annotations", "BE24-05-01001.txt")
    classes_file = os.path.join(base_folder, "Annotations", "anchor_annotations", "classes.txt")

...
if __name__ == "__main__":
    ...
    folder_path = os.path.join(base_folder, "TestData", "BE_24_Series")
    annotations_file = os.path.join(base_folder, "Annotations", "full_annotations", "labels", "BE24-05-01001.txt")
    classes_file = os.path.join(base_folder, "Annotations", "full_annotations", "classes.txt")
    anchor_data_json_path = os.path.join(base_folder, "anchor_BE_24_Series", "anchor_centers.json")
